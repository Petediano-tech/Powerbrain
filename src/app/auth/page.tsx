      ...
      <div className="w-full max-w-sm mt-6 text-center">
            ...
            >
              ...
              >
                ...
                <path
                  fill="#34A853"
                  d="m492.8 261.8-.4 12.7c-.3 12.7-.7 25.4-.7 38.4 0 141.5-97.1 242.2-244.3 242.2-137.2 0-248-110.8-248-248S110.8 8 248 8c66.8 0 126 23.4 172.9 61.9l-76.2 76.2c-27.3-26.2-62.7-42.3-100.9-42.3-83.3 0-151.7 68.4-151.7 151.7s68.4 151.7 151.7 151.7c96.5 0 134.4-69.2 140.2-101.8H248v-95.6H492.8z"
                ></path>
                <path
                  fill="#FBBC05"
                  d="M248 103.7c-83.3 0-151.7 68.4-151.7 151.7s68.4 151.7 151.7 151.7c96.5 0 134.4-69.2 140.2-101.8H248v-95.6h239.8c.4 12.7.7 25.4.7 38.4-2.4-71.1-34.6-133.3-83.8-176.4l-76.1 76.1c24.2 21.9 39.1 52.8 39.1 87.8z"
                ></path>
                <path
                  fill="#EA4335"
                  d="M248 103.7c-83.3 0-151.7 68.4-151.7 151.7s68.4 151.7 151.7 151.7c4.2 0 8.3-.2 12.4-.6-4.5 14.1-10.1 27.6-16.7 40.2-27.3-26.2-62.7-42.3-100.9-42.3-83.3 0-151.7 68.4-151.7 151.7s68.4 151.7 151.7 151.7c66.8 0 126-23.4 172.9-61.9l-76.2-76.2c-27.3-26.2-62.7-42.3-100.9-42.3z"
                ></path>
              </svg>
